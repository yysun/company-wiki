...
Apply [Publication](publication.md) before exposing metadata or reading wiki bytes. Validate independently enumerates
the safely visible selected-scope taxonomy and its bounded typed-link overlay. It is
...
Recheck current evidence access, audience, and continuing protection before treating a derived claim as usable.
Report unknown lineage/protection and unsafe legacy exposure without quoting restricted titles, routes, or content.
