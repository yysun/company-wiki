...
- [x] Reconcile PRD sections 7–8, personal access requirements, current lifecycle acceptance criteria, and English,
...
- [ ] Run independent read-only scenario evaluation against the completed skill and review all changes since base.
- [ ] Run Python unit/contract suites, skill validator, and relative-link/diff checks; record limits and final evidence.
